...
public class testRLPacman extends Application {
    ...
    /**
     * nombre d'experiences a lancer (pour faire une moyenne), une experience
     * est un apprentissage sur plusieurs parties
     */
    static int nbmean = 3;
    /**
    ...
    /**
     * nombre de parties ou l'on affiche le jeu pacman pour voir le comportement
     * appris
     */
...
/*        	pacmanmdp = new EnvironnementPacmanFeatureRL(mazename,true);//smallGrid smallGrid2 mediumGrid
    ...
    /**
     * trace courbe moyenne sur plusieurs expe, affiche jeu pacman sur derniers
     * episodes greedy de derniere expe
     */
